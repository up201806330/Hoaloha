<?php function draw_edit_animal($animal,$topic){
    ...
    <div class="register-content">
      ...
      <form method="post" action="../actions/action_edit_animal.php">
        ...
        <div class="txt_field">
          <input type="text" name="description" value="<?=$topic['description']?>" required>
          <span></span>
          <label>Description</label>
        </div>
        <select name='species'>
            <option value=''>&#xf039; &nbsp; Select a Species</option>
            <option value='Dog' <?php if($animal['species'] == "dog") {echo " selected";}?>>&#xf6d3; &nbsp; Dog</option> <!-- maybe do this with javascript-->
        ...
        <div class="txt_field">
          <input type="text" name="breed" value="<?=ucfirst($animal['breed'])?>" required>
          <span></span>
          <label>Breed</label>
        </div>
        <select name='gender'>
        ...
        <div class="details">
          ...
          <div class="txt_field">
            <input type="text" name="color" value="<?=ucfirst($animal['color'])?>" required>
            <span></span>
            <label>Color</label>
            </div>
